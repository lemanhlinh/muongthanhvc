...
$tmpl->addScript('plugin/jquery.min');
$tmpl->addScript('plugin/jquery-ui.min');
$tmpl->addScript('plugin/datatables.min');
$tmpl->addScript('plugin/bootstrap.bundle.min');
...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="<?php echo URL_ROOT ?>images/logo.png" alt="AdminLTELogo" height="60" width="60">
    </div>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu py-0" aria-labelledby="navbarVersionDropdown">
                    <a class="dropdown-item bg-info disabled" href="#">User name</a>
                    <a class="dropdown-item" href="#thoat">Thoát</a>
                </div>
            </li>
        </ul>
    </nav>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="" class="brand-link">
            <img src="<?php echo URL_ROOT ?>images/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">Mường thanh</span>
        </a>
