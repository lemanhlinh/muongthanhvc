                    ...
                    foreach ($col as $item) {
                        ...
                        switch ($type) {
                            ...
                            case 'preview':
                                ...
                                if ($link_web) {
                                    $link_web = str_replace('ccode=ccode', 'ccode=' . $row->alias, $link_web);
                            ...
                            case 'table_name':
                                ...
                                break;
//                            case 'status':
////                                $status = isset($row->{$item['field']}) ? $row->{$item['field']} : '';
...
//				$compare = $value;
    ...
    static function dt_edit_selectbox($title, $name, $value, $default = '', $arry_select = array(), $field_value = 'id', $field_label = 'name', $size = 1, $multi = 0, $add_fisrt_option = 0, $comment = '', $sub_item = '', $class = 'chosen-select chosen-select-deselect', $class_col1 = 'col-md-3', $class_col2 = 'col-md-9', $field = '',$tool_tip = '0',$html_tool_tip='')
    {
        // phan quyen theo field
        $module = FSInput::get('module');
        $view = FSInput::get('view', $module);
...
//				echo "<script>CKEDITOR.replace( '".$name."');</script>";
    ...
    static function dt_edit_image2($title, $name, $value, $width = 0, $height = 0, $comment = '', $use_dropzone = 0, $list_other_images = array(), $class_col1 = 'col-md-3', $class_col2 = 'col-md-9')
    {
        ...
        if (!$use_dropzone) {
            ...
            $no_img = "this.src='/images/video-btn.png'";
    ...
    public static function create_filter($row, $prefix)
    {
        ...
        if (isset($row['search'])) {
            $html .= '<div class="fl-left pd-15" style="margin:10px 0">';
